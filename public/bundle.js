    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p1 = element("p");
    			t25 = text(t25_value);
    			add_location(h1, file, 12, 2, 215);
    			attr_dev(a0, "href", "https://zeit.co/docs");
    			attr_dev(a0, "target", "_blank");
    			attr_dev(a0, "rel", "noreferrer noopener");
    			add_location(a0, file, 15, 4, 274);
    			add_location(h20, file, 13, 2, 247);
    			attr_dev(a1, "href", "https://github.com/zeit/now/tree/master/examples/svelte");
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "rel", "noreferrer noopener");
    			add_location(a1, file, 21, 4, 396);
    			attr_dev(a2, "href", "https://svelte.dev/");
    			add_location(a2, file, 28, 4, 564);
    			add_location(code0, file, 30, 4, 641);
    			add_location(code1, file, 32, 4, 689);
    			add_location(code2, file, 34, 4, 747);
    			attr_dev(a3, "href", "https://nodejs.org/en/");
    			add_location(a3, file, 36, 4, 801);
    			add_location(code3, file, 39, 6, 895);
    			attr_dev(a4, "href", "/api/date");
    			add_location(a4, file, 38, 4, 868);
    			add_location(p0, file, 20, 2, 388);
    			add_location(br, file, 44, 2, 977);
    			add_location(h21, file, 45, 2, 986);
    			add_location(p1, file, 46, 2, 1031);
    			add_location(main, file, 11, 0, 206);
    		},
